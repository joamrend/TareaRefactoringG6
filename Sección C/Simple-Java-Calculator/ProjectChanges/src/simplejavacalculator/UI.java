...
public class UI implements ActionListener {
   ...
   private void configureFonts() {
      ...
      JButton[] operationButtons = {
         butAdd, butMinus, butMultiply, butDivide, butEqual,
         butSquareRoot, butSquare, butOneDividedBy, butCos,
         butSin, butTan, butln, butxpowerofy, butlog,
         butrate, butabs, butCancel, butBinary
      };
   ...
   private void buildPanels() {
      ...
      addNumberRow(panelSub2, 1, 2, 3, butAdd, butMinus);
      addNumberRow(panelSub3, 4, 5, 6, butMultiply, butDivide);
      addNumberRow(panelSub4, 7, 8, 9, butEqual, butCancel);
   ...
   private void addNumberRow(JPanel panelRow, int a, int b, int c, JButton op1, JButton op2) {
      panelRow.add(but[a]);
      panelRow.add(but[b]);
      panelRow.add(but[c]);
      panelRow.add(Box.createHorizontalStrut(15));
      panelRow.add(op1);
      panelRow.add(op2);
      panel.add(panelRow);
   }
   private void registerListeners() {
      ...
      JButton[] allButtons = {
         butAdd, butMinus, butMultiply, butDivide, butSquare,
         butSquareRoot, butOneDividedBy, butCos, butSin, butTan,
         butln, butxpowerofy, butlog, butrate, butabs,
         butBinary, butEqual, butCancel
      };
